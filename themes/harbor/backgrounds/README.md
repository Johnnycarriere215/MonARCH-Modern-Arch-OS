...
Wallpapers for the **harbor** theme (slate teal/amber). `monarch background next` cycles
them; `monarch background pick` shows a menu; `monarch theme apply harbor` sets
the first one.
...
|---|---|---|---|
| `monarch-harbor-01-gradient.jpg` | diagonal wash | generated from `colors.toml` | MIT (MonARCH) |
| `monarch-harbor-02-glow.jpg`     | accent bloom  | generated from `colors.toml` | MIT (MonARCH) |
| `monarch-harbor-03-aurora.jpg`   | colour bands  | generated from `colors.toml` | MIT (MonARCH) |
